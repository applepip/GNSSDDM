...
plot_snacs_results('/tmp/snacs-result_example07/result.h5', plotting);

% save the figure:
save_figure_as_png('../../documentation/doxygen-sources/graphic/snacs-result_example07.png', 1024, 768);
