...
main() {
	...
	double cut_off_frequency = 25.575e6;
	double smpl_freq = 120e6;
	bands[0] = 0;
	bands[1] = cut_off_frequency / smpl_freq / 2.0;
	bands[2] = 0.15 + (cut_off_frequency / smpl_freq / 2.0);
	bands[3] = 0.5;

	printf("PF: band[0]: %f, band[1]: %f, band[2]: %f, band[3]: %f\n", bands[0], bands[1], bands[2], bands[3]);
